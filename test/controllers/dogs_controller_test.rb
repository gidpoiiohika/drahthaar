...
class DogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create dog" do
    assert_difference("Dog.count") do
      post dogs_url, params: { dog: { description: @dog.description, father: @dog.father, mother: @dog.mother, name: @dog.name, stigma: @dog.stigma } }
    end
  ...
  test "should update dog" do
    patch dog_url(@dog), params: { dog: { description: @dog.description, father: @dog.father, mother: @dog.mother, name: @dog.name, stigma: @dog.stigma } }
